...
/**
 The base class for all vkevents modules
 */
...
/**
 vkevents Platform calls this method on startup.
 */
-(void)startup;

/**
 vkevents Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 vkevents Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 vkevents Platform calls this method on resume.
 @param sender The sender of the event.
 */
