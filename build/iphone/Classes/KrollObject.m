 ...
 * Copyright (c) 2009-2011 by vkevents, Inc. All Rights Reserved.
...
//@interface vkeventsObject : NSObject
//@end

@interface vkeventsObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[vkeventsObject class]])
		{
			for (NSString *key in [[(vkeventsObject*)o modules] allKeys])
			{
