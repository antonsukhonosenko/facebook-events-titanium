...
// in simulator we redefine to format for vkevents Developer console
...
{\
	NSString * exceptionName = [@"org.vkevents." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.vkevents";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIvkeventsNativeItemNone = -1, 
	UIvkeventsNativeItemSpinner = -2,
	UIvkeventsNativeItemProgressBar = -3,
	
	UIvkeventsNativeItemSlider = -4,
	UIvkeventsNativeItemSwitch = -5,
	UIvkeventsNativeItemMultiButton = -6,
	UIvkeventsNativeItemSegmented = -7,
	
	UIvkeventsNativeItemTextView = -8,
	UIvkeventsNativeItemTextField = -9,
	UIvkeventsNativeItemSearchBar = -10,
	
	UIvkeventsNativeItemPicker = -11,
	UIvkeventsNativeItemDatePicker = -12,
	
	UIvkeventsNativeItemInfoLight = -13,
	UIvkeventsNativeItemInfoDark = -14,
	
	UIvkeventsNativeItemDisclosure = -15,
	
	UIvkeventsNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all vkevents instances of
